...
macro(configureCMake)
    ...
    if (IMHEX_USE_DEFAULT_BUILD_SETTINGS)
        ...
        if (LD__PATH)
            set(CMAKE_LINKER ${LD__PATH})

            if (NOT XCODE AND NOT MSVC)
                set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} -march=znver2 -fuse-ld=lld)
                set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} -march=znver2 -fuse-ld=lld)
            endif()
        else ()
